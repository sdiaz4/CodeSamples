...
**Disclaimer**
These samples do not represent the entirety of my academic work or technical experience. The code is provided for demonstration and educational purposes only, and I am not responsible for any misuse or unauthorized use of the material.

**Programming I**
- Introduction to programming using C++, covering fundamental concepts such as variables, control structures, functions, and problem-solving techniques.
**Web Development I**
- Foundations of web development, including HTML, CSS, and introductory JavaScript.
**Web Development II**
...
- Study of relational (SQL) and non-relational (NoSQL) databases, including design, querying, and data modeling.
**Data Communications and Networking**
- Study of how data is transmitted across networks, including protocols, IP addressing, routing, and communication systems.

**Languages:**  
C++, JavaScript, Java, SQL, PHP

**Web Technologies:**  
HTML, CSS, React, Node.js, Express, MongoDB

**Cloud & Tools:**  
AWS, Git, GitHub, Linux/Unix

**Concepts:**  
Object-Oriented Programming, Networking, Databases, Operating Systems
